            ...
            children: [
              if (notice.isPinned) ...[
                Container(
                  ...
                  child: const Text('공지', style: TextStyle(fontSize: 11, fontWeight: FontWeight.w600, color: AppColors.primary)),
                ),
              ...
              Text(_formatDate(notice.createdAt), style: const TextStyle(fontSize: 12, color: AppColors.inkFaint)),

...
mixin _$Submission {
 ...
 int get id; String get nickname; String? get videoUrl; String? get assetPath; String? get thumbnailUrl; int get commentCount;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,nickname,videoUrl,assetPath,thumbnailUrl,commentCount);

@override
String toString() {
  return 'Submission(id: $id, nickname: $nickname, videoUrl: $videoUrl, assetPath: $assetPath, thumbnailUrl: $thumbnailUrl, commentCount: $commentCount)';
}
...
@useResult
$Res call({
 int id, String nickname, String? videoUrl, String? assetPath, String? thumbnailUrl, int commentCount
});
...
/// Create a copy of Submission
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? nickname = null,Object? videoUrl = freezed,Object? assetPath = freezed,Object? thumbnailUrl = freezed,Object? commentCount = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String nickname,  String? videoUrl,  String? assetPath,  String? thumbnailUrl,  int commentCount)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Submission() when $default != null:
return $default(_that.id,_that.nickname,_that.videoUrl,_that.assetPath,_that.thumbnailUrl,_that.commentCount);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  String nickname,  String? videoUrl,  String? assetPath,  String? thumbnailUrl,  int commentCount)  $default,) {final _that = this;
switch (_that) {
case _Submission():
return $default(_that.id,_that.nickname,_that.videoUrl,_that.assetPath,_that.thumbnailUrl,_that.commentCount);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  String nickname,  String? videoUrl,  String? assetPath,  String? thumbnailUrl,  int commentCount)?  $default,) {final _that = this;
switch (_that) {
case _Submission() when $default != null:
return $default(_that.id,_that.nickname,_that.videoUrl,_that.assetPath,_that.thumbnailUrl,_that.commentCount);case _:
  return null;
...
class _Submission implements Submission {
  const _Submission({required this.id, required this.nickname, this.videoUrl, this.assetPath, this.thumbnailUrl, this.commentCount = 0});
...
/// Create a copy of Submission
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? nickname = null,Object? videoUrl = freezed,Object? assetPath = freezed,Object? thumbnailUrl = freezed,Object? commentCount = null,}) {

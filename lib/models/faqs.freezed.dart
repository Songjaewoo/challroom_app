...
mixin _$Faq {
 ...
 int get id; String get question; String get answer;/// 목록에서 묶어 보여줄 분류 — "계정", "방/챌린지" 처럼.
 String get category;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Faq&&(identical(other.id, id) || other.id == id)&&(identical(other.question, question) || other.question == question)&&(identical(other.answer, answer) || other.answer == answer)&&(identical(other.category, category) || other.category == category));
}
...
@override
String toString() {
  return 'Faq(id: $id, question: $question, answer: $answer, category: $category)';
}
...
@useResult
$Res call({
 int id, String question, String answer, String category
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String question,  String answer,  String category)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Faq() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  String question,  String answer,  String category)  $default,) {final _that = this;
switch (_that) {
case _Faq():
return $default(_that.id,_that.question,_that.answer,_that.category);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  String question,  String answer,  String category)?  $default,) {final _that = this;
switch (_that) {
case _Faq() when $default != null:
return $default(_that.id,_that.question,_that.answer,_that.category);case _:
  return null;
...
class _Faq implements Faq {
  const _Faq({required this.id, required this.question, required this.answer, required this.category});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Faq&&(identical(other.id, id) || other.id == id)&&(identical(other.question, question) || other.question == question)&&(identical(other.answer, answer) || other.answer == answer)&&(identical(other.category, category) || other.category == category));
}
